[![](https://jb.gg/badges/incubator-flat-square.svg)](https://github.com/JetBrains)
...
```
dotnet add package JetBrains.Space.Client --prerelease
```
...
* `HandleCreateExternalIssueRequestAsync` is called when an external issue is created.
