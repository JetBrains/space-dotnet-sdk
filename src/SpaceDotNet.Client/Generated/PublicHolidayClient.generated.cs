...
namespace SpaceDotNet.Client
{
    public partial class PublicHolidayClient
    {
        ...
        public partial class CalendarClient
        {
            ...
            /// </summary>
            public async Task<PublicHolidayCalendarRecord> CreateCalendarAsync(string name, string location, Func<Partial<PublicHolidayCalendarRecord>, Partial<PublicHolidayCalendarRecord>>? partial = null)
            ...
            /// </summary>
            public async Task<Batch<PublicHolidayCalendarRecord>> GetAllCalendarsAsync(string? skip = null, int? top = 100, Func<Partial<Batch<PublicHolidayCalendarRecord>>, Partial<Batch<PublicHolidayCalendarRecord>>>? partial = null)
                => await _connection.RequestResourceAsync<Batch<PublicHolidayCalendarRecord>>("GET", $"api/http/public-holidays/calendars?$skip={skip?.ToString() ?? "null"}&$top={top?.ToString() ?? "null"}&$fields={(partial != null ? partial(new Partial<Batch<PublicHolidayCalendarRecord>>()) : Partial<Batch<PublicHolidayCalendarRecord>>.Default())}");
            
            /// <summary>
            /// Get all public holiday calendars.
            /// </summary>
            public IAsyncEnumerable<PublicHolidayCalendarRecord> GetAllCalendarsAsyncEnumerable(string? skip = null, int? top = 100, Func<Partial<PublicHolidayCalendarRecord>, Partial<PublicHolidayCalendarRecord>>? partial = null)
                => BatchEnumerator.AllItems(batchSkip => GetAllCalendarsAsync(top: top, skip: batchSkip, partial: builder => Partial<Batch<PublicHolidayCalendarRecord>>.Default().WithNext().WithTotalCount().WithData(partial != null ? partial : _ => Partial<PublicHolidayCalendarRecord>.Default())), skip);
        
            /// <summary>
            /// Update an existing public holiday calendar.
            /// </summary>
            public async Task<PublicHolidayCalendarRecord> UpdateCalendarAsync(string id, string name, string location, Func<Partial<PublicHolidayCalendarRecord>, Partial<PublicHolidayCalendarRecord>>? partial = null)
        ...
        public partial class HolidayClient
        {
            ...
            /// </summary>
            public async Task<PublicHoliday> CreateHolidayAsync(string calendar, string name, SpaceDate date, bool workingDay, Func<Partial<PublicHoliday>, Partial<PublicHoliday>>? partial = null)
            ...
            /// </summary>
            public async Task<Batch<PublicHoliday>> GetAllHolidaysAsync(string? skip = null, int? top = 100, string? calendar = null, string? location = null, SpaceDate? startDate = null, SpaceDate? endDate = null, Func<Partial<Batch<PublicHoliday>>, Partial<Batch<PublicHoliday>>>? partial = null)
            ...
            /// Get/search all holidays in a public holiday calendar. Parameters are applied as 'AND' filters.
            /// </summary>
            public IAsyncEnumerable<PublicHoliday> GetAllHolidaysAsyncEnumerable(string? skip = null, int? top = 100, string? calendar = null, string? location = null, SpaceDate? startDate = null, SpaceDate? endDate = null, Func<Partial<PublicHoliday>, Partial<PublicHoliday>>? partial = null)
                => BatchEnumerator.AllItems(batchSkip => GetAllHolidaysAsync(top: top, calendar: calendar, location: location, startDate: startDate, endDate: endDate, skip: batchSkip, partial: builder => Partial<Batch<PublicHoliday>>.Default().WithNext().WithTotalCount().WithData(partial != null ? partial : _ => Partial<PublicHoliday>.Default())), skip);
            ...
            /// </summary>
            public async Task<PublicHoliday> UpdateHolidayAsync(string id, string? calendar = null, string? name = null, SpaceDate? date = null, bool? workingDay = null, Func<Partial<PublicHoliday>, Partial<PublicHoliday>>? partial = null)
            ...
            public partial class ProfileHolidayClient
            {
                ...
                /// </summary>
                public async Task<List<PublicHoliday>> GetAllProfileHolidaysAsync(SpaceDate startDate, SpaceDate endDate, string profile, bool? workingDays = null, Func<Partial<PublicHoliday>, Partial<PublicHoliday>>? partial = null)
                    => await _connection.RequestResourceAsync<List<PublicHoliday>>("GET", $"api/http/public-holidays/holidays/profile-holidays?startDate={startDate.ToString()}&endDate={endDate.ToString()}&profile={profile.ToString()}&workingDays={workingDays?.ToString()?.ToLowerInvariant() ?? "null"}&$fields={(partial != null ? partial(new Partial<PublicHoliday>()) : Partial<PublicHoliday>.Default())}");
            ...
            public partial class RelatedHolidayClient
            {
                ...
                /// </summary>
                public async Task<Batch<PublicHoliday>> GetAllRelatedHolidaysAsync(string? skip = null, int? top = 100, SpaceDate? startDate = null, SpaceDate? endDate = null, Func<Partial<Batch<PublicHoliday>>, Partial<Batch<PublicHoliday>>>? partial = null)
                ...
                /// Search related holidays in all public holiday calendars, during the selected period.
                /// </summary>
                public IAsyncEnumerable<PublicHoliday> GetAllRelatedHolidaysAsyncEnumerable(string? skip = null, int? top = 100, SpaceDate? startDate = null, SpaceDate? endDate = null, Func<Partial<PublicHoliday>, Partial<PublicHoliday>>? partial = null)
                    => BatchEnumerator.AllItems(batchSkip => GetAllRelatedHolidaysAsync(top: top, startDate: startDate, endDate: endDate, skip: batchSkip, partial: builder => Partial<Batch<PublicHoliday>>.Default().WithNext().WithTotalCount().WithData(partial != null ? partial : _ => Partial<PublicHoliday>.Default())), skip);
