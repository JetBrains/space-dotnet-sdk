...
namespace SpaceDotNet.Client
{
         ...
         : IPropagatePropertyAccessPath
    {
        ...
        private PropertyValue<string> _idpEntityId = new PropertyValue<string>(nameof(AuthModulesForIdSamlMetadataRequest), nameof(IdpEntityId));
        ...
        private PropertyValue<string> _idpCertificateSHA256 = new PropertyValue<string>(nameof(AuthModulesForIdSamlMetadataRequest), nameof(IdpCertificateSHA256));
        ...
        private PropertyValue<string> _spEntityId = new PropertyValue<string>(nameof(AuthModulesForIdSamlMetadataRequest), nameof(SpEntityId));
        ...
        private PropertyValue<SSLKeystoreDto?> _sslKeystore = new PropertyValue<SSLKeystoreDto?>(nameof(AuthModulesForIdSamlMetadataRequest), nameof(SslKeystore));
        ...
        private PropertyValue<string?> _contactProfileId = new PropertyValue<string?>(nameof(AuthModulesForIdSamlMetadataRequest), nameof(ContactProfileId));
