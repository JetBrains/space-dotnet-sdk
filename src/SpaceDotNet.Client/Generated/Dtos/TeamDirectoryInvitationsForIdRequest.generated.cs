...
namespace SpaceDotNet.Client
{
         ...
         : IPropagatePropertyAccessPath
    {
        ...
        private PropertyValue<string?> _inviteeFirstName = new PropertyValue<string?>(nameof(TeamDirectoryInvitationsForIdRequest), nameof(InviteeFirstName));
        ...
        private PropertyValue<string?> _inviteeLastName = new PropertyValue<string?>(nameof(TeamDirectoryInvitationsForIdRequest), nameof(InviteeLastName));
        ...
        private PropertyValue<TDTeamDto?> _team = new PropertyValue<TDTeamDto?>(nameof(TeamDirectoryInvitationsForIdRequest), nameof(Team));
        ...
        private PropertyValue<TDRoleDto?> _role = new PropertyValue<TDRoleDto?>(nameof(TeamDirectoryInvitationsForIdRequest), nameof(Role));
