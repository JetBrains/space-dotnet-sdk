...
namespace SpaceDotNet.Client
{
    public class CreateIssueRequest
    {
        ...
        public string? Assignee { get { return _assignee.GetValue(); } set { _assignee.SetValue(value); } }
    
        private PropertyValue<string> _status = new PropertyValue<string>(nameof(CreateIssueRequest), nameof(Status));
        
        [Required]
        [JsonPropertyName("status")]
        public string Status { get { return _status.GetValue(); } set { _status.SetValue(value); } }
        ...
        public List<string> Checklists { get { return _checklists.GetValue(); } set { _checklists.SetValue(value); } }
