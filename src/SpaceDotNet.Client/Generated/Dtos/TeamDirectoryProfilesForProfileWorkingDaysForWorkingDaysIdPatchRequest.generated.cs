...
namespace SpaceDotNet.Client
{
         ...
         : IPropagatePropertyAccessPath
    {
        ...
        private PropertyValue<SpaceDate?> _dateStart = new PropertyValue<SpaceDate?>(nameof(TeamDirectoryProfilesForProfileWorkingDaysForWorkingDaysIdPatchRequest), nameof(DateStart));
        ...
        private PropertyValue<SpaceDate?> _dateEnd = new PropertyValue<SpaceDate?>(nameof(TeamDirectoryProfilesForProfileWorkingDaysForWorkingDaysIdPatchRequest), nameof(DateEnd));
