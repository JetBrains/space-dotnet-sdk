...
namespace SpaceDotNet.Client
{
         ...
         : IPropagatePropertyAccessPath
    {
        ...
        private PropertyValue<int> _y = new PropertyValue<int>(nameof(TeamDirectoryMemberLocationsForIdPointsRequest), nameof(Y));
        ...
        private PropertyValue<string> _mapId = new PropertyValue<string>(nameof(TeamDirectoryMemberLocationsForIdPointsRequest), nameof(MapId));
