...
namespace SpaceDotNet.Client
{
         ...
         : IPropagatePropertyAccessPath
    {
        ...
        private PropertyValue<string?> _timezone = new PropertyValue<string?>(nameof(TeamDirectoryLocationsRequest), nameof(Timezone));
        ...
        private PropertyValue<List<int>?> _workdays = new PropertyValue<List<int>?>(nameof(TeamDirectoryLocationsRequest), nameof(Workdays));
        ...
        private PropertyValue<List<string>?> _phones = new PropertyValue<List<string>?>(nameof(TeamDirectoryLocationsRequest), nameof(Phones));
        ...
        private PropertyValue<List<string>?> _emails = new PropertyValue<List<string>?>(nameof(TeamDirectoryLocationsRequest), nameof(Emails));
        ...
        private PropertyValue<List<string>?> _equipment = new PropertyValue<List<string>?>(nameof(TeamDirectoryLocationsRequest), nameof(Equipment));
        ...
        private PropertyValue<string?> _description = new PropertyValue<string?>(nameof(TeamDirectoryLocationsRequest), nameof(Description));
        ...
        private PropertyValue<string?> _address = new PropertyValue<string?>(nameof(TeamDirectoryLocationsRequest), nameof(Address));
        ...
        private PropertyValue<string?> _type = new PropertyValue<string?>(nameof(TeamDirectoryLocationsRequest), nameof(Type));
        ...
        private PropertyValue<string?> _parentId = new PropertyValue<string?>(nameof(TeamDirectoryLocationsRequest), nameof(ParentId));
