...
{
    public class TeamDirectoryMemberLocationsRequest
         : IPropagatePropertyAccessPath
    {
        ...
        private PropertyValue<string> _location = new PropertyValue<string>(nameof(TeamDirectoryMemberLocationsRequest), nameof(Location));
        ...
        private PropertyValue<SpaceDate?> _since = new PropertyValue<SpaceDate?>(nameof(TeamDirectoryMemberLocationsRequest), nameof(Since));
        ...
        private PropertyValue<SpaceDate?> _till = new PropertyValue<SpaceDate?>(nameof(TeamDirectoryMemberLocationsRequest), nameof(Till));
        ...
        private PropertyValue<string?> _previousLocation = new PropertyValue<string?>(nameof(TeamDirectoryMemberLocationsRequest), nameof(PreviousLocation));
