...
namespace SpaceDotNet.Client
{
    public sealed class DiffDto
    {
        ...
        public List<string> Added { get { return _added.GetValue(); } set { _added.SetValue(value); } }
    
        private PropertyValue<List<string>> _removed = new PropertyValue<List<string>>(nameof(DiffDto), nameof(Removed));
        
        [Required]
        [JsonPropertyName("removed")]
        public List<string> Removed { get { return _removed.GetValue(); } set { _removed.SetValue(value); } }
    
        private PropertyValue<bool> _removeAll = new PropertyValue<bool>(nameof(DiffDto), nameof(RemoveAll));
        
        [Required]
        [JsonPropertyName("removeAll")]
        public bool RemoveAll { get { return _removeAll.GetValue(); } set { _removeAll.SetValue(value); } }
