...
namespace SpaceDotNet.Client
{
         ...
         : IPropagatePropertyAccessPath
    {
        ...
        private PropertyValue<string?> _afterItemId = new PropertyValue<string?>(nameof(ProjectsForProjectPlanningChecklistsForChecklistIdImportRequest), nameof(AfterItemId));
        ...
        private PropertyValue<string> _tabIndentedLines = new PropertyValue<string>(nameof(ProjectsForProjectPlanningChecklistsForChecklistIdImportRequest), nameof(TabIndentedLines));
