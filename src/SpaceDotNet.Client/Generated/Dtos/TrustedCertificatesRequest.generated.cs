...
namespace SpaceDotNet.Client
{
         ...
         : IPropagatePropertyAccessPath
    {
        ...
        private PropertyValue<string> _data = new PropertyValue<string>(nameof(TrustedCertificatesRequest), nameof(Data));
        ...
        private PropertyValue<bool> _archived = new PropertyValue<bool>(nameof(TrustedCertificatesRequest), nameof(Archived));
