...
{
    public class ImportSourcesForSourceIdPatchRequest
         : IPropagatePropertyAccessPath
    {
        public ImportSourcesForSourceIdPatchRequest() { }
        
        public ImportSourcesForSourceIdPatchRequest(string name, string importerPrincipal)
        {
            Name = name;
            ImporterPrincipal = importerPrincipal;
        }
        
        private PropertyValue<string> _name = new PropertyValue<string>(nameof(ImportSourcesForSourceIdPatchRequest), nameof(Name));
