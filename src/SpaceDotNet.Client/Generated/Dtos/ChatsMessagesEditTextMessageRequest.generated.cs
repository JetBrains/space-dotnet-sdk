...
namespace SpaceDotNet.Client
{
         ...
         : IPropagatePropertyAccessPath
    {
        ...
        private PropertyValue<string> _text = new PropertyValue<string>(nameof(ChatsMessagesEditTextMessageRequest), nameof(Text));
        ...
        private PropertyValue<string> _messageId = new PropertyValue<string>(nameof(ChatsMessagesEditTextMessageRequest), nameof(MessageId));
