...
namespace SpaceDotNet.Client
{
         ...
         : IPropagatePropertyAccessPath
    {
        ...
        public TeamDirectoryMembershipsRequest(string memberId, string teamId, string roleId, bool lead, bool requiresApproval, string? managerId = null, SpaceTime? activeSince = null, SpaceTime? activeTill = null, string? previousMembershipId = null, List<CustomFieldValueDto>? customFieldValues = null)
        {
            MemberId = memberId;
            TeamId = teamId;
            RoleId = roleId;
        ...
        private PropertyValue<string> _roleId = new PropertyValue<string>(nameof(TeamDirectoryMembershipsRequest), nameof(RoleId));
        ...
        private PropertyValue<bool> _lead = new PropertyValue<bool>(nameof(TeamDirectoryMembershipsRequest), nameof(Lead));
        ...
        private PropertyValue<SpaceTime?> _activeTill = new PropertyValue<SpaceTime?>(nameof(TeamDirectoryMembershipsRequest), nameof(ActiveTill));
        ...
        private PropertyValue<string?> _previousMembershipId = new PropertyValue<string?>(nameof(TeamDirectoryMembershipsRequest), nameof(PreviousMembershipId));
        ...
        private PropertyValue<bool> _requiresApproval = new PropertyValue<bool>(nameof(TeamDirectoryMembershipsRequest), nameof(RequiresApproval));
        ...
        private PropertyValue<List<CustomFieldValueDto>?> _customFieldValues = new PropertyValue<List<CustomFieldValueDto>?>(nameof(TeamDirectoryMembershipsRequest), nameof(CustomFieldValues));
