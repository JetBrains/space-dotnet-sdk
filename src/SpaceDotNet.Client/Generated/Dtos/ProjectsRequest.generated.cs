...
namespace SpaceDotNet.Client
{
         ...
         : IPropagatePropertyAccessPath
    {
        ...
        private PropertyValue<string> _name = new PropertyValue<string>(nameof(ProjectsRequest), nameof(Name));
        ...
        private PropertyValue<string?> _description = new PropertyValue<string?>(nameof(ProjectsRequest), nameof(Description));
