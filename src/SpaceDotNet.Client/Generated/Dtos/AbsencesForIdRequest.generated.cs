...
namespace SpaceDotNet.Client
{
         ...
         : IPropagatePropertyAccessPath
    {
        ...
        private PropertyValue<string?> _reason = new PropertyValue<string?>(nameof(AbsencesForIdRequest), nameof(Reason));
        ...
        private PropertyValue<string?> _description = new PropertyValue<string?>(nameof(AbsencesForIdRequest), nameof(Description));
        ...
        private PropertyValue<string?> _location = new PropertyValue<string?>(nameof(AbsencesForIdRequest), nameof(Location));
        ...
        private PropertyValue<SpaceDate?> _since = new PropertyValue<SpaceDate?>(nameof(AbsencesForIdRequest), nameof(Since));
        ...
        private PropertyValue<SpaceDate?> _till = new PropertyValue<SpaceDate?>(nameof(AbsencesForIdRequest), nameof(Till));
        ...
        private PropertyValue<bool> _available = new PropertyValue<bool>(nameof(AbsencesForIdRequest), nameof(Available));
        ...
        private PropertyValue<string?> _icon = new PropertyValue<string?>(nameof(AbsencesForIdRequest), nameof(Icon));
        ...
        private PropertyValue<List<CustomFieldValueDto>?> _customFieldValues = new PropertyValue<List<CustomFieldValueDto>?>(nameof(AbsencesForIdRequest), nameof(CustomFieldValues));
