...
namespace SpaceDotNet.Client
{
         ...
         : IPropagatePropertyAccessPath
    {
        ...
        private PropertyValue<string?> _teamDescription = new PropertyValue<string?>(nameof(TeamDirectoryTeamsRequest), nameof(TeamDescription));
        ...
        private PropertyValue<List<string>?> _teamEmails = new PropertyValue<List<string>?>(nameof(TeamDirectoryTeamsRequest), nameof(TeamEmails));
        ...
        private PropertyValue<string?> _parentId = new PropertyValue<string?>(nameof(TeamDirectoryTeamsRequest), nameof(ParentId));
        ...
        private PropertyValue<List<CustomFieldValueDto>?> _customFieldValues = new PropertyValue<List<CustomFieldValueDto>?>(nameof(TeamDirectoryTeamsRequest), nameof(CustomFieldValues));
