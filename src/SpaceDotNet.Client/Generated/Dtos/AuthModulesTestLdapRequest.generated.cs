...
namespace SpaceDotNet.Client
{
         ...
         : IPropagatePropertyAccessPath
    {
        ...
        private PropertyValue<string> _username = new PropertyValue<string>(nameof(AuthModulesTestLdapRequest), nameof(Username));
        ...
        private PropertyValue<string> _password = new PropertyValue<string>(nameof(AuthModulesTestLdapRequest), nameof(Password));
