...
namespace SpaceDotNet.Client
{
         ...
         : IPropagatePropertyAccessPath
    {
        ...
        private PropertyValue<SpaceDate?> _dateStart = new PropertyValue<SpaceDate?>(nameof(TeamDirectoryProfilesForIdWorkingDaysForWorkingDaysIdRequest), nameof(DateStart));
        ...
        private PropertyValue<SpaceDate?> _dateEnd = new PropertyValue<SpaceDate?>(nameof(TeamDirectoryProfilesForIdWorkingDaysForWorkingDaysIdRequest), nameof(DateEnd));
        ...
        private PropertyValue<WorkingDaysSpecDto> _workingDaysSpec = new PropertyValue<WorkingDaysSpecDto>(nameof(TeamDirectoryProfilesForIdWorkingDaysForWorkingDaysIdRequest), nameof(WorkingDaysSpec));
