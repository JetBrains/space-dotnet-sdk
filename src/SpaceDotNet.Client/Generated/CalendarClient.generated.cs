...
namespace SpaceDotNet.Client
{
    public partial class CalendarClient
    {
        ...
        public partial class MeetingClient
        {
            ...
            /// </summary>
            public async Task<DTOMeetingDto> CreateMeetingAsync(string summary, CalendarEventSpecDto occurrenceRule, List<string> locations, List<string> profiles, List<string> externalParticipants, List<string> teams, MeetingVisibility visibility, MeetingModificationPreference modificationPreference, MeetingJoiningPreference joiningPreference, bool notifyOnExport, string? description = null, string? organizer = null, Func<Partial<DTOMeetingDto>, Partial<DTOMeetingDto>>? partial = null)
            ...
            /// </summary>
            public async Task<Batch<DTOMeetingDto>> GetAllMeetingsAsync(string summaryQuery, List<string> locationsQuery, List<string> profiles, List<string> teams, bool includePrivate, bool includeArchived, bool includeMeetingInstances, string? skip = null, int? top = null, SpaceTime? startingAfter = null, SpaceTime? endingBefore = null, string? organizer = null, Func<Partial<Batch<DTOMeetingDto>>, Partial<Batch<DTOMeetingDto>>>? partial = null)
            ...
            /// Search meetings by name, location, time period and other parameters. Parameters are applied as 'AND' filters while values in lists of locations, profiles and teams have 'OR' semantics.
            /// </summary>
            public IAsyncEnumerable<DTOMeetingDto> GetAllMeetingsAsyncEnumerable(string summaryQuery, List<string> locationsQuery, List<string> profiles, List<string> teams, bool includePrivate, bool includeArchived, bool includeMeetingInstances, string? skip = null, int? top = null, SpaceTime? startingAfter = null, SpaceTime? endingBefore = null, string? organizer = null, Func<Partial<DTOMeetingDto>, Partial<DTOMeetingDto>>? partial = null)
