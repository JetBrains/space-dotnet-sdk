...
namespace SpaceDotNet.Client
{
    public partial class AbsenceClient
    {
        ...
        public async Task<List<AbsenceRecordDto>> GetAllAbsencesByMember(string member, Func<Partial<List<AbsenceRecordDto>>, Partial<List<AbsenceRecordDto>>> partialBuilder = null)
            => await _connection.RequestResourceAsync<List<AbsenceRecordDto>>("GET", $"api/http/absences/member:{member}?$fields=" + (partialBuilder != null ? partialBuilder(new Partial<List<AbsenceRecordDto>>()) : Partial<List<AbsenceRecordDto>>.Default()));        
        ...
        public partial class AbsenceReasonClient
        {
            ...
            public async Task<List<AbsenceReasonRecordDto>> GetAllAbsenceReasons(bool withArchived, Func<Partial<List<AbsenceReasonRecordDto>>, Partial<List<AbsenceReasonRecordDto>>> partialBuilder = null)
                => await _connection.RequestResourceAsync<List<AbsenceReasonRecordDto>>("GET", $"api/http/absences/absence-reasons?withArchived={withArchived.ToString().ToLowerInvariant()}&$fields=" + (partialBuilder != null ? partialBuilder(new Partial<List<AbsenceReasonRecordDto>>()) : Partial<List<AbsenceReasonRecordDto>>.Default()));            
        ...
        public partial class SubscriptionClient
        {
            ...
            public async Task<List<DTOAbsenceSubscriptionDto>> GetAllSubscriptions(Func<Partial<List<DTOAbsenceSubscriptionDto>>, Partial<List<DTOAbsenceSubscriptionDto>>> partialBuilder = null)
                => await _connection.RequestResourceAsync<List<DTOAbsenceSubscriptionDto>>("GET", $"api/http/absences/subscriptions?$fields=" + (partialBuilder != null ? partialBuilder(new Partial<List<DTOAbsenceSubscriptionDto>>()) : Partial<List<DTOAbsenceSubscriptionDto>>.Default()));            
