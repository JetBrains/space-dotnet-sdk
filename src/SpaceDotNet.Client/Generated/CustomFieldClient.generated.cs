...
// 
//     Generated: 2020-05-18T15:15:45.3122447+00:00
// </auto-generated>
// ------------------------------------------------------------------------------
    ...
    public partial class CustomFieldClient
    {
        ...
        public partial class ExtendedTypeClient
        {
            ...
            public async Task<List<ExtendedTypeDto>> GetAllExtendedTypes(Func<Partial<List<ExtendedTypeDto>>, Partial<List<ExtendedTypeDto>>> partialBuilder = null)
                => await _connection.RequestResourceAsync<List<ExtendedTypeDto>>("GET", $"api/http/custom-fields/extended-types?$fields=" + (partialBuilder != null ? partialBuilder(new Partial<List<ExtendedTypeDto>>()) : new EagerPartial<List<ExtendedTypeDto>>()));            
        ...
        public partial class FieldClient
        {
            ...
            public async Task<CustomFieldDto> CreateField(string typeKey, CreateFieldRequestDto data, Func<Partial<CustomFieldDto>, Partial<CustomFieldDto>> partialBuilder = null)
                => await _connection.RequestResourceAsync<CreateFieldRequestDto, CustomFieldDto>("POST", $"api/http/custom-fields/{typeKey}/fields?$fields=" + (partialBuilder != null ? partialBuilder(new Partial<CustomFieldDto>()) : new EagerPartial<CustomFieldDto>()), data);            
            ...
            public async Task<List<CustomFieldDto>> GetAllFields(string typeKey, bool withArchived, Func<Partial<List<CustomFieldDto>>, Partial<List<CustomFieldDto>>> partialBuilder = null)
                => await _connection.RequestResourceAsync<List<CustomFieldDto>>("GET", $"api/http/custom-fields/{typeKey}/fields?withArchived={withArchived.ToString().ToLowerInvariant()}&$fields=" + (partialBuilder != null ? partialBuilder(new Partial<List<CustomFieldDto>>()) : new EagerPartial<List<CustomFieldDto>>()));            
        ...
        public partial class ValueClient
        {
            ...
            public async Task<CustomFieldsRecordDto> GetValue(string typeKey, string entityId, Func<Partial<CustomFieldsRecordDto>, Partial<CustomFieldsRecordDto>> partialBuilder = null)
                => await _connection.RequestResourceAsync<CustomFieldsRecordDto>("GET", $"api/http/custom-fields/{typeKey}/{entityId}/values?$fields=" + (partialBuilder != null ? partialBuilder(new Partial<CustomFieldsRecordDto>()) : new EagerPartial<CustomFieldsRecordDto>()));            
