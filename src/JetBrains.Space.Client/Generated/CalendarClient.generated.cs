...
public partial class CalendarClient : ISpaceClient
{
    ...
    public partial class EventParticipationClient : ISpaceClient
    {
        ...
        /// </summary>
        public async Task<MeetingRecord> UpdateEventParticipationAsync(string id, EventParticipationStatus newStatus, Func<Partial<MeetingRecord>, Partial<MeetingRecord>>? partial = null, Dictionary<string, string>? requestHeaders = null, CancellationToken cancellationToken = default)
        {
            var queryParameters = new NameValueCollection();
    ...
    public partial class EventClient : ISpaceClient
    {
        ...
        /// </summary>
        public async Task<List<MeetingRecord>> GetAllEventsAsync(DateTime dateFrom, DateTime dateTo, Func<Partial<MeetingRecord>, Partial<MeetingRecord>>? partial = null, Dictionary<string, string>? requestHeaders = null, CancellationToken cancellationToken = default)
        {
            var queryParameters = new NameValueCollection();
            queryParameters.Append("dateFrom", dateFrom.ToString("yyyy-MM-dd", CultureInfo.InvariantCulture));
            queryParameters.Append("dateTo", dateTo.ToString("yyyy-MM-dd", CultureInfo.InvariantCulture));
        ...
        /// </summary>
        public async Task<MeetingRecord> GetEventAsync(string id, Func<Partial<MeetingRecord>, Partial<MeetingRecord>>? partial = null, Dictionary<string, string>? requestHeaders = null, CancellationToken cancellationToken = default)
        {
            var queryParameters = new NameValueCollection();
            queryParameters.Append("$fields", (partial != null ? partial(new Partial<MeetingRecord>()) : Partial<MeetingRecord>.Default()).ToString());
    ...
    public partial class MeetingClient : ISpaceClient
    {
        ...
        /// </list>
        /// </remarks>
        public async Task<MeetingOccurrenceTime> GetNextMeetingOccurrenceAsync(string meetingId, DateTime? since = null, Func<Partial<MeetingOccurrenceTime>, Partial<MeetingOccurrenceTime>>? partial = null, Dictionary<string, string>? requestHeaders = null, CancellationToken cancellationToken = default)
        {
            var queryParameters = new NameValueCollection();
        ...
        /// </list>
        /// </remarks>
        public async Task<List<MeetingOccurrenceTime>> GetMeetingOccurrencesForPeriodAsync(string meetingId, DateTime since, DateTime until, int? limit = null, Func<Partial<MeetingOccurrenceTime>, Partial<MeetingOccurrenceTime>>? partial = null, Dictionary<string, string>? requestHeaders = null, CancellationToken cancellationToken = default)
        {
            var queryParameters = new NameValueCollection();
            queryParameters.Append("meetingId", meetingId);
        ...
        /// </list>
        /// </remarks>
        public async Task<List<MeetingWithOccurrenceTime>> GetMeetingOccurrencesForPeriodForMultipleMeetingsAsync(List<string> meetingIds, DateTime since, DateTime until, int? limit = null, Func<Partial<MeetingWithOccurrenceTime>, Partial<MeetingWithOccurrenceTime>>? partial = null, Dictionary<string, string>? requestHeaders = null, CancellationToken cancellationToken = default)
        {
            var queryParameters = new NameValueCollection();
        ...
        /// </list>
        /// </remarks>
        public async Task<List<EventParticipationStatus>> GetMeetingParticipationStatusesForProfilesAsync(string id, List<string> profileIds, Func<Partial<EventParticipationStatus>, Partial<EventParticipationStatus>>? partial = null, Dictionary<string, string>? requestHeaders = null, CancellationToken cancellationToken = default)
        {
            var queryParameters = new NameValueCollection();
        ...
        /// </list>
        /// </remarks>
        public async Task<List<EventParticipationStatus>> GetRsvpStatusesForExternalUsersAsync(string id, List<string> emails, Func<Partial<EventParticipationStatus>, Partial<EventParticipationStatus>>? partial = null, Dictionary<string, string>? requestHeaders = null, CancellationToken cancellationToken = default)
        {
            var queryParameters = new NameValueCollection();
            queryParameters.Append("id", id);
        ...
        public async Task<List<Pair<string, EventParticipationStatus>>> GetProfileParticipationStatusesForMeetingsAsync(string profileId, List<string> events, Func<Partial<Pair<string, EventParticipationStatus>>, Partial<Pair<string, EventParticipationStatus>>>? partial = null, Dictionary<string, string>? requestHeaders = null, CancellationToken cancellationToken = default)
        {
            var queryParameters = new NameValueCollection();
        ...
        /// </list>
        /// </remarks>
        public async Task<List<MeetingRSVP>> GetProfileParticipationStatusRecordsForMeetingsAsync(string profileId, List<string> events, Func<Partial<MeetingRSVP>, Partial<MeetingRSVP>>? partial = null, Dictionary<string, string>? requestHeaders = null, CancellationToken cancellationToken = default)
        {
            var queryParameters = new NameValueCollection();
            queryParameters.Append("profileId", profileId);
            queryParameters.Append("events", events.Select(it => it));
        ...
        /// </list>
        /// </remarks>
        public async Task<Meeting> GetMeetingAsync(string id, Func<Partial<Meeting>, Partial<Meeting>>? partial = null, Dictionary<string, string>? requestHeaders = null, CancellationToken cancellationToken = default)
        {
            var queryParameters = new NameValueCollection();
            queryParameters.Append("$fields", (partial != null ? partial(new Partial<Meeting>()) : Partial<Meeting>.Default()).ToString());
        ...
        /// </list>
        /// </remarks>
        public async Task<Meeting> DeleteMeetingAsync(string id, RecurrentModification modificationKind = RecurrentModification.All, DateTime? targetDate = null, Func<Partial<Meeting>, Partial<Meeting>>? partial = null, Dictionary<string, string>? requestHeaders = null, CancellationToken cancellationToken = default)
        {
            var queryParameters = new NameValueCollection();
        ...
        public partial class ParticipationStatuClient : ISpaceClient
        {
            ...
            /// </list>
            /// </remarks>
            public async Task<Meeting> UpdateProfileParticipationStatusAsync(string id, string profileId, EventParticipationStatus status, RecurrentModification modificationKind = RecurrentModification.All, DateTime? targetDate = null, Func<Partial<Meeting>, Partial<Meeting>>? partial = null, Dictionary<string, string>? requestHeaders = null, CancellationToken cancellationToken = default)
            {
                var queryParameters = new NameValueCollection();
                queryParameters.Append("$fields", (partial != null ? partial(new Partial<Meeting>()) : Partial<Meeting>.Default()).ToString());
