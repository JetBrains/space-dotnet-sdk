...
namespace JetBrains.Space.Client
{
         ...
         : SubscriptionFilterIn, IClassNameConvertible, IPropagatePropertyAccessPath
    {
        ...
        public PackagesSubscriptionFilterIn(List<string> projects, List<string> namePattern, string? repository = null, string? versionPattern = null)
        {
            Projects = projects;
        ...
        private PropertyValue<List<string>> _projects = new PropertyValue<List<string>>(nameof(PackagesSubscriptionFilterIn), nameof(Projects), new List<string>());
