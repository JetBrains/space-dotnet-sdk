...
public sealed class ESComposerRepositorySettings
     : ESPackageRepositorySettings, IClassNameConvertible, IPropagatePropertyAccessPath
{
    [JsonPropertyName("className")]
    public override string? ClassName => "ES_ComposerRepositorySettings";
    
    public ESComposerRepositorySettings() { }
    
    public ESComposerRepositorySettings(RetentionPolicyParams? retentionPolicyParams = null, bool? immutablePackageVersions = null)
    {
        RetentionPolicyParams = retentionPolicyParams;
        IsImmutablePackageVersions = immutablePackageVersions;
    }
    
    private PropertyValue<RetentionPolicyParams?> _retentionPolicyParams = new PropertyValue<RetentionPolicyParams?>(nameof(ESComposerRepositorySettings), nameof(RetentionPolicyParams), "retentionPolicyParams");
    ...
    private PropertyValue<bool?> _immutablePackageVersions = new PropertyValue<bool?>(nameof(ESComposerRepositorySettings), nameof(IsImmutablePackageVersions), "immutablePackageVersions");
