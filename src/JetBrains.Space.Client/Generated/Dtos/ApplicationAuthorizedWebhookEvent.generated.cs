     ...
     : WebhookEvent, IClassNameConvertible, IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<KMetaMod> _meta = new PropertyValue<KMetaMod>(nameof(ApplicationAuthorizedWebhookEvent), nameof(Meta), "meta");
    ...
    private PropertyValue<ESApp> _application = new PropertyValue<ESApp>(nameof(ApplicationAuthorizedWebhookEvent), nameof(Application), "application");
    ...
    private PropertyValue<AuthScope> _scope = new PropertyValue<AuthScope>(nameof(ApplicationAuthorizedWebhookEvent), nameof(Scope), "scope");
