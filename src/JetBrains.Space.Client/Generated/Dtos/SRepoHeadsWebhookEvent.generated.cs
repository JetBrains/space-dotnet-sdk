     ...
     : WebhookEvent, IClassNameConvertible, IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<ProjectKey> _projectKey = new PropertyValue<ProjectKey>(nameof(SRepoHeadsWebhookEvent), nameof(ProjectKey), "projectKey");
    ...
    private PropertyValue<string> _repository = new PropertyValue<string>(nameof(SRepoHeadsWebhookEvent), nameof(Repository), "repository");
    ...
    private PropertyValue<RepoChanges> _changes = new PropertyValue<RepoChanges>(nameof(SRepoHeadsWebhookEvent), nameof(Changes), "changes");
