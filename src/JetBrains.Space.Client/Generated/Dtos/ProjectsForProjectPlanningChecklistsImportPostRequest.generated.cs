...
internal class ProjectsForProjectPlanningChecklistsImportPostRequest
     : IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<string> _name = new PropertyValue<string>(nameof(ProjectsForProjectPlanningChecklistsImportPostRequest), nameof(Name), "name");
    ...
    private PropertyValue<string> _tabIndentedLines = new PropertyValue<string>(nameof(ProjectsForProjectPlanningChecklistsImportPostRequest), nameof(TabIndentedLines), "tabIndentedLines");
