     ...
     : M2ItemContentDetails, IClassNameConvertible, IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<AbsenceRecord> _absence = new PropertyValue<AbsenceRecord>(nameof(M2AbsenceItemDeletedContent), nameof(Absence), "absence");
    ...
    private PropertyValue<TDMemberProfile?> _by = new PropertyValue<TDMemberProfile?>(nameof(M2AbsenceItemDeletedContent), nameof(By), "by");
