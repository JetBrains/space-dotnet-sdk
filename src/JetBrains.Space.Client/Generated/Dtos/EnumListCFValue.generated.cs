     ...
     : CFValue, CFInputValue, IClassNameConvertible, IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<List<EnumValueData>> _values = new PropertyValue<List<EnumValueData>>(nameof(EnumListCFValue), nameof(Values), "values", new List<EnumValueData>());
