...
public sealed class ESDartRepositorySettings
     : ESPackageRepositorySettings, IClassNameConvertible, IPropagatePropertyAccessPath
{
    [JsonPropertyName("className")]
    public override string? ClassName => "ES_DartRepositorySettings";
    ...
    private PropertyValue<bool?> _immutablePackageVersions = new PropertyValue<bool?>(nameof(ESDartRepositorySettings), nameof(IsImmutablePackageVersions), "immutablePackageVersions");
