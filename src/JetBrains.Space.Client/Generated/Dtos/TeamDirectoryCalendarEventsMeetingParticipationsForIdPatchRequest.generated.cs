...
internal class TeamDirectoryCalendarEventsMeetingParticipationsForIdPatchRequest
     : IPropagatePropertyAccessPath
{
    public TeamDirectoryCalendarEventsMeetingParticipationsForIdPatchRequest() { }
    
    public TeamDirectoryCalendarEventsMeetingParticipationsForIdPatchRequest(EventParticipationStatus newStatus)
    {
        NewStatus = newStatus;
    }
