...
internal class AbsencesForIdPatchRequest
     : IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<bool> _available = new PropertyValue<bool>(nameof(AbsencesForIdPatchRequest), nameof(IsAvailable), "available");
