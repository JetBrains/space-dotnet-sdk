     ...
     : IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<string?> _authorId = new PropertyValue<string?>(nameof(RdDevConfiguration), nameof(AuthorId), "authorId");
