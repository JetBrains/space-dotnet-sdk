     ...
     : MCOutline, IClassNameConvertible, IPropagatePropertyAccessPath
{
    ...
    public MCOutlineV2(List<MCInlineElement> elements)
    {
        Elements = elements;
    }
    
    private PropertyValue<List<MCInlineElement>> _elements = new PropertyValue<List<MCInlineElement>>(nameof(MCOutlineV2), nameof(Elements), "elements", new List<MCInlineElement>());
