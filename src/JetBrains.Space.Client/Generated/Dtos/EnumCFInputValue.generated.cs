     ...
     : CFInputValue, IClassNameConvertible, IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<CFEnumValueIdentifier?> _enumValueIdentifier = new PropertyValue<CFEnumValueIdentifier?>(nameof(EnumCFInputValue), nameof(EnumValueIdentifier), "enumValueIdentifier");
