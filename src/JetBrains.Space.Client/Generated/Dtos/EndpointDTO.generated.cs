     ...
     : IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<string?> _url = new PropertyValue<string?>(nameof(EndpointDTO), nameof(Url));
    ...
    private PropertyValue<bool> _sslVerification = new PropertyValue<bool>(nameof(EndpointDTO), nameof(IsSslVerification));
