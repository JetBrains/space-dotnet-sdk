     ...
     : IPropagatePropertyAccessPath
{
    ...
    public EndpointDTO(bool sslVerification, string? url = null)
    {
        Url = url;
        IsSslVerification = sslVerification;
    }
    
    private PropertyValue<string?> _url = new PropertyValue<string?>(nameof(EndpointDTO), nameof(Url), "url");
    ...
    private PropertyValue<bool> _sslVerification = new PropertyValue<bool>(nameof(EndpointDTO), nameof(IsSslVerification), "sslVerification");
