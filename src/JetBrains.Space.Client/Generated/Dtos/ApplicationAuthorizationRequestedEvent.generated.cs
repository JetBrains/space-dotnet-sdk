...
namespace JetBrains.Space.Client
{
         ...
         : WebhookEvent, IClassNameConvertible, IPropagatePropertyAccessPath
    {
        ...
        public ApplicationAuthorizationRequestedEvent(KMetaMod meta, ESService application, AuthScope scope)
        {
            Meta = meta;
        ...
        private PropertyValue<ESService> _application = new PropertyValue<ESService>(nameof(ApplicationAuthorizationRequestedEvent), nameof(Application));
        
        [Required]
        [JsonPropertyName("application")]
        public ESService Application
        {
