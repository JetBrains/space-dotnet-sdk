     ...
     : IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<List<FolderAccessRecipient>?> _permissions = new PropertyValue<List<FolderAccessRecipient>?>(nameof(FolderAccess), nameof(Permissions), "permissions");
    
    [JsonPropertyName("permissions")]
    public List<FolderAccessRecipient>? Permissions
    {
