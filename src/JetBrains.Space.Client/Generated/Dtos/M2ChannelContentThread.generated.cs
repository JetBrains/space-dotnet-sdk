     ...
     : M2ChannelContentInfo, IClassNameConvertible, IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<ChannelItemRecord> _record = new PropertyValue<ChannelItemRecord>(nameof(M2ChannelContentThread), nameof(Record), "record");
    ...
    private PropertyValue<M2ChannelRecord> _parent = new PropertyValue<M2ChannelRecord>(nameof(M2ChannelContentThread), nameof(Parent), "parent");
