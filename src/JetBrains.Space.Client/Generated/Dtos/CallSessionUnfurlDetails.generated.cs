...
public sealed class CallSessionUnfurlDetails
     : UnfurlDetails, IClassNameConvertible, IPropagatePropertyAccessPath
{
    [JsonPropertyName("className")]
    public  string? ClassName => "CallSessionUnfurlDetails";
    
    public CallSessionUnfurlDetails() { }
    
    public CallSessionUnfurlDetails(CallSession session)
    {
        Session = session;
    }
