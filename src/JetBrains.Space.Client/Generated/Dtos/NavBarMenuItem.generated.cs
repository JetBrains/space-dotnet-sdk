     ...
     : IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<string> _item = new PropertyValue<string>(nameof(NavBarMenuItem), nameof(Item), "item");
    ...
    private PropertyValue<bool> _enabled = new PropertyValue<bool>(nameof(NavBarMenuItem), nameof(IsEnabled), "enabled");
