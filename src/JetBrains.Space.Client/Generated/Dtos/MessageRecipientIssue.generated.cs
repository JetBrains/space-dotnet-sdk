...
{
    public sealed class MessageRecipientIssue
         : MessageRecipient, IClassNameConvertible, IPropagatePropertyAccessPath
    {
        [JsonPropertyName("className")]
        public override string? ClassName => "MessageRecipient.Issue";
        ...
        private PropertyValue<string> _issue = new PropertyValue<string>(nameof(MessageRecipientIssue), nameof(Issue));
