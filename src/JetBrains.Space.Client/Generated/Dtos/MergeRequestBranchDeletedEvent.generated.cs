     ...
     : FeedEvent, IClassNameConvertible, IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<string> _repository = new PropertyValue<string>(nameof(MergeRequestBranchDeletedEvent), nameof(Repository), "repository");
    ...
    private PropertyValue<string> _branch = new PropertyValue<string>(nameof(MergeRequestBranchDeletedEvent), nameof(Branch), "branch");
    ...
    private PropertyValue<MergeRequestBranchType> _branchType = new PropertyValue<MergeRequestBranchType>(nameof(MergeRequestBranchDeletedEvent), nameof(BranchType), "branchType");
