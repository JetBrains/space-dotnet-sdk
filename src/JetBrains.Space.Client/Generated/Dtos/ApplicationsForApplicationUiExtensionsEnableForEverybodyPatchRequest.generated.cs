     ...
     : IPropagatePropertyAccessPath
{
    ...
    public ApplicationsForApplicationUiExtensionsEnableForEverybodyPatchRequest(PermissionContextIdentifier contextIdentifier)
    {
        ContextIdentifier = contextIdentifier;
    }
    
    private PropertyValue<PermissionContextIdentifier> _contextIdentifier = new PropertyValue<PermissionContextIdentifier>(nameof(ApplicationsForApplicationUiExtensionsEnableForEverybodyPatchRequest), nameof(ContextIdentifier), "contextIdentifier");
