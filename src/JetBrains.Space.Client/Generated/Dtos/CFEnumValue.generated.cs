     ...
     : IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<string> _id = new PropertyValue<string>(nameof(CFEnumValue), nameof(Id), "id");
    ...
    private PropertyValue<string> _value = new PropertyValue<string>(nameof(CFEnumValue), nameof(Value), "value");
    ...
    private PropertyValue<CPrincipalDetails?> _principal = new PropertyValue<CPrincipalDetails?>(nameof(CFEnumValue), nameof(Principal), "principal");
