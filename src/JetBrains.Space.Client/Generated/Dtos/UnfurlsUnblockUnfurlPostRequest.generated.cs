...
internal class UnfurlsUnblockUnfurlPostRequest
     : IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<string> _link = new PropertyValue<string>(nameof(UnfurlsUnblockUnfurlPostRequest), nameof(Link), "link");
    ...
    private PropertyValue<bool> _wholeHost = new PropertyValue<bool>(nameof(UnfurlsUnblockUnfurlPostRequest), nameof(IsWholeHost), "wholeHost");
