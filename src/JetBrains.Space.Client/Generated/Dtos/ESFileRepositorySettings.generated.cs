...
public sealed class ESFileRepositorySettings
     : ESPackageRepositorySettings, IClassNameConvertible, IPropagatePropertyAccessPath
{
    [JsonPropertyName("className")]
    public override string? ClassName => "ES_FileRepositorySettings";
    
    public ESFileRepositorySettings() { }
    
    public ESFileRepositorySettings(RetentionPolicyParams? retentionPolicyParams = null, bool? immutablePackageVersions = null, bool? writePermissionForCachingArtifacts = null)
    {
    ...
    private PropertyValue<RetentionPolicyParams?> _retentionPolicyParams = new PropertyValue<RetentionPolicyParams?>(nameof(ESFileRepositorySettings), nameof(RetentionPolicyParams), "retentionPolicyParams");
    ...
    private PropertyValue<bool?> _immutablePackageVersions = new PropertyValue<bool?>(nameof(ESFileRepositorySettings), nameof(IsImmutablePackageVersions), "immutablePackageVersions");
    ...
    private PropertyValue<bool?> _writePermissionForCachingArtifacts = new PropertyValue<bool?>(nameof(ESFileRepositorySettings), nameof(IsWritePermissionForCachingArtifacts), "writePermissionForCachingArtifacts");
