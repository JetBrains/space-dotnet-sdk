...
internal class TeamDirectoryProfilesForProfileApplicationPasswordsPostRequest
     : IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<string> _name = new PropertyValue<string>(nameof(TeamDirectoryProfilesForProfileApplicationPasswordsPostRequest), nameof(Name), "name");
