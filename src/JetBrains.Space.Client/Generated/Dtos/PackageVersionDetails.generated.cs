     ...
     : IClassNameConvertible, IPropagatePropertyAccessPath
{
    ...
    public static ContainerPackageVersionDetails Container(PackageType type, string repository, string name, string version, long created, long downloads, bool pinned, long diskSize, int schemaVersion, string mediaType, string manifestType, List<string>? tags = null, long? accessed = null, string? comment = null, CPrincipal? author = null, List<CPrincipal>? authors = null, PackageOrigin? origin = null, Dictionary<string, string>? metadata = null, ContainerImage? image = null, ContainerHelmChart? chart = null, PackageVersionRef? subject = null)
        => new ContainerPackageVersionDetails(type: type, repository: repository, name: name, version: version, created: created, downloads: downloads, pinned: pinned, diskSize: diskSize, schemaVersion: schemaVersion, mediaType: mediaType, manifestType: manifestType, tags: tags, accessed: accessed, comment: comment, author: author, authors: authors, origin: origin, metadata: metadata, image: image, chart: chart, subject: subject);
