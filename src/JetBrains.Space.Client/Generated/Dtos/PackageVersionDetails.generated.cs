     ...
     : IClassNameConvertible, IPropagatePropertyAccessPath
{
    ...
    public static PythonPackageVersionDetails Python(string repository, string name, string version, long created, long downloads, bool pinned, long diskSize, string notNormalizedName, string platform, List<string> keywords, List<string> classifiers, List<PythonPackageUrl> projectUrls, List<string> requiresDist, List<PythonPackageFile> files, List<string>? tags = null, long? accessed = null, string? comment = null, CPrincipal? author = null, List<CPrincipal>? authors = null, PackageOrigin? origin = null, Dictionary<string, string>? metadata = null, string? summary = null, string? description = null, string? descriptionContentType = null, string? homePage = null, string? authorFromPackageDetails = null, string? authorEmail = null, string? maintainer = null, string? maintainerEmail = null, string? license = null, string? requiresPython = null)
        => new PythonPackageVersionDetails(repository: repository, name: name, version: version, created: created, downloads: downloads, pinned: pinned, diskSize: diskSize, notNormalizedName: notNormalizedName, platform: platform, keywords: keywords, classifiers: classifiers, projectUrls: projectUrls, requiresDist: requiresDist, files: files, tags: tags, accessed: accessed, comment: comment, author: author, authors: authors, origin: origin, metadata: metadata, summary: summary, description: description, descriptionContentType: descriptionContentType, homePage: homePage, authorFromPackageDetails: authorFromPackageDetails, authorEmail: authorEmail, maintainer: maintainer, maintainerEmail: maintainerEmail, license: license, requiresPython: requiresPython);
