...
internal class CalendarsEventParticipationsForIdPatchRequest
     : IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<EventParticipationStatus> _newStatus = new PropertyValue<EventParticipationStatus>(nameof(CalendarsEventParticipationsForIdPatchRequest), nameof(NewStatus), "newStatus");
