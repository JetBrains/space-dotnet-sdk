...
internal class ProjectsForProjectAccessAdminsProfilesPostRequest
     : IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<ProfileIdentifier> _profile = new PropertyValue<ProfileIdentifier>(nameof(ProjectsForProjectAccessAdminsProfilesPostRequest), nameof(Profile), "profile");
