...
public sealed class ApplicationHomepageUiExtensionApi
     : PageUiExtensionApi, IClassNameConvertible, IPropagatePropertyAccessPath
{
    [JsonPropertyName("className")]
    public  string? ClassName => "ApplicationHomepageUiExtensionApi";
