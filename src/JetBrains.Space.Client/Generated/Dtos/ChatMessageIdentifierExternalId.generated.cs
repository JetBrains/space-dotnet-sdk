...
public sealed class ChatMessageIdentifierExternalId
     : IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<string> _externalId = new PropertyValue<string>(nameof(ChatMessageIdentifierExternalId), nameof(ExternalId), "externalId");
