     ...
     : InlineUnfurlDetails, IClassNameConvertible, IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<string> _channel = new PropertyValue<string>(nameof(UnfurlDetailsChat), nameof(Channel), "channel");
    ...
    private PropertyValue<string> _title = new PropertyValue<string>(nameof(UnfurlDetailsChat), nameof(Title), "title");
