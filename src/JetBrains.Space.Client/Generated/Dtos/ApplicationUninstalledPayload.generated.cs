...
public sealed class ApplicationUninstalledPayload
     : ApplicationPayload, IClassNameConvertible, IPropagatePropertyAccessPath
{
    [JsonPropertyName("className")]
    public  string? ClassName => "ApplicationUninstalledPayload";
    
    public ApplicationUninstalledPayload() { }
    
    public ApplicationUninstalledPayload(string serverUrl, string clientId, string? verificationToken = null)
    {
        ServerUrl = serverUrl;
        ClientId = clientId;
    ...
    private PropertyValue<string> _serverUrl = new PropertyValue<string>(nameof(ApplicationUninstalledPayload), nameof(ServerUrl), "serverUrl");
    ...
    private PropertyValue<string> _clientId = new PropertyValue<string>(nameof(ApplicationUninstalledPayload), nameof(ClientId), "clientId");
    ...
    private PropertyValue<string?> _verificationToken = new PropertyValue<string?>(nameof(ApplicationUninstalledPayload), nameof(VerificationToken), "verificationToken");
