     ...
     : IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<string> _name = new PropertyValue<string>(nameof(GitAuthorInfo), nameof(Name), "name");
    ...
    private PropertyValue<string> _email = new PropertyValue<string>(nameof(GitAuthorInfo), nameof(Email), "email");
