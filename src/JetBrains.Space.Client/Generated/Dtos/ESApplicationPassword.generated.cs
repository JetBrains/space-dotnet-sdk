     ...
     : IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<string> _id = new PropertyValue<string>(nameof(ESApplicationPassword), nameof(Id), "id");
    ...
    private PropertyValue<TDMemberProfile> _profile = new PropertyValue<TDMemberProfile>(nameof(ESApplicationPassword), nameof(Profile), "profile");
    ...
    private PropertyValue<string> _name = new PropertyValue<string>(nameof(ESApplicationPassword), nameof(Name), "name");
    ...
    private PropertyValue<DateTime> _created = new PropertyValue<DateTime>(nameof(ESApplicationPassword), nameof(Created), "created");
    ...
    private PropertyValue<AccessRecord?> _lastAccess = new PropertyValue<AccessRecord?>(nameof(ESApplicationPassword), nameof(LastAccess), "lastAccess");
