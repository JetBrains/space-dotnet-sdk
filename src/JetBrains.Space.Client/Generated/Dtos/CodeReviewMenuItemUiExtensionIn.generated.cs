...
public sealed class CodeReviewMenuItemUiExtensionIn
     : ContextMenuItemUiExtensionIn, IClassNameConvertible, IPropagatePropertyAccessPath
{
    [JsonPropertyName("className")]
    public override string? ClassName => "CodeReviewMenuItemUiExtensionIn";
    ...
    private PropertyValue<string?> _description = new PropertyValue<string?>(nameof(CodeReviewMenuItemUiExtensionIn), nameof(Description), "description");
    ...
    private PropertyValue<string> _menuItemUniqueCode = new PropertyValue<string>(nameof(CodeReviewMenuItemUiExtensionIn), nameof(MenuItemUniqueCode), "menuItemUniqueCode");
    ...
    private PropertyValue<List<CodeReviewMenuItemVisibilityFilterIn>> _visibilityFilters = new PropertyValue<List<CodeReviewMenuItemVisibilityFilterIn>>(nameof(CodeReviewMenuItemUiExtensionIn), nameof(VisibilityFilters), "visibilityFilters", new List<CodeReviewMenuItemVisibilityFilterIn>());
    
    [Required]
    [JsonPropertyName("visibilityFilters")]
    public List<CodeReviewMenuItemVisibilityFilterIn> VisibilityFilters
    {
