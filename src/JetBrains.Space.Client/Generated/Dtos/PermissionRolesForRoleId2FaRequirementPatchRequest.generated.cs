     ...
     : IPropagatePropertyAccessPath
{
    ...
    public PermissionRolesForRoleId2FaRequirementPatchRequest(bool? required = null)
    {
        IsRequired = required;
    }
    
    private PropertyValue<bool?> _required = new PropertyValue<bool?>(nameof(PermissionRolesForRoleId2FaRequirementPatchRequest), nameof(IsRequired), "required");
