     ...
     : IssueChangedM2Details, IClassNameConvertible, IPropagatePropertyAccessPath
{
    ...
    private PropertyValue<string> _oldTitle = new PropertyValue<string>(nameof(IssueTitleChangedDetails), nameof(OldTitle), "oldTitle");
    ...
    private PropertyValue<string> _newTitle = new PropertyValue<string>(nameof(IssueTitleChangedDetails), nameof(NewTitle), "newTitle");
