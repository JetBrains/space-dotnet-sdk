...
public sealed class GettingStartedUiExtensionIn
     : AppUiExtensionIn, IClassNameConvertible, IPropagatePropertyAccessPath
{
    [JsonPropertyName("className")]
    public  string? ClassName => "GettingStartedUiExtensionIn";
    ...
    private PropertyValue<string> _gettingStartedTitle = new PropertyValue<string>(nameof(GettingStartedUiExtensionIn), nameof(GettingStartedTitle), "gettingStartedTitle");
