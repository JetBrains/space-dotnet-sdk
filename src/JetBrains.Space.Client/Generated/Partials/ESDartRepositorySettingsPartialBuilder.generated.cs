...
namespace JetBrains.Space.Client.ESDartRepositorySettingsPartialBuilder;

public static class ESDartRepositorySettingsPartialExtensions
{
    public static Partial<ESDartRepositorySettings> WithRetentionPolicyParams(this Partial<ESDartRepositorySettings> it)
        => it.AddFieldName("retentionPolicyParams");
    
    public static Partial<ESDartRepositorySettings> WithRetentionPolicyParams(this Partial<ESDartRepositorySettings> it, Func<Partial<RetentionPolicyParams>, Partial<RetentionPolicyParams>> partialBuilder)
