...
namespace JetBrains.Space.Client.EventExternalSourcePartialBuilder;

public static class EventExternalSourcePartialExtensions
{
    public static Partial<EventExternalSource> WithSourceName(this Partial<EventExternalSource> it)
        => it.AddFieldName("sourceName");
    
    public static Partial<EventExternalSource> WithExternalId(this Partial<EventExternalSource> it)
