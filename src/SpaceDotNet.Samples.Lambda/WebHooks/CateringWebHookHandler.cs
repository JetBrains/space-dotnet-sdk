...
namespace SpaceDotNet.Samples.Lambda.WebHooks
{
    public class CateringWebHookHandlerStartupTask : BackgroundService
    {
        ...
        public CateringWebHookHandlerStartupTask(ServiceClient serviceClient, ChatClient chatClient)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            //     recipient: MessageRecipient.Member(ProfileIdentifier.Username("Maarten.Balliauw")),
            //     content: ChatMessage.Text("Hellooo!"),
            //     unfurlLinks: false);
            //
